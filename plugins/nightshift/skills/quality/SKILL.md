...
attached from (`skills/quality/SKILL.md`) — and run every command below through `runtime/ns`,
...
with the same flags. Use the PowerShell tool and native paths; do not route Quality through WSL
