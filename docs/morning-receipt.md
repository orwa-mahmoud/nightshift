...
The page opens with a `Receipts:` heading and a markdown list — `[index](./README.md)`, then one
relative link per ticked item, named from the item number and slug, in punch-list order. Directly under that, a
